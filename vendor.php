                    ...
                    <div class="col-sm-6 mt-3 mb-4">
                        <div class="card w-100">
                            <div class="card-body text-center">
                                <a href="smartphones.php?id=<?= $vendor->id?>"> <img src="img/vendors/<?= $vendor->picture ?>" class="card-img-top" ></a>
                                <div class="card-body">
                                    <a class="card-link text-dark text-decoration-none" href="vendor.php"><?= $vendor->description ?></a>
                                </div>
